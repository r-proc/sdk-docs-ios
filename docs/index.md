...
При регистрации в сервисе, каждому пользователю открывается электронным кошелек, в одной из парнтерский кредитных организаций. Оплата производится с этого кошелька, причем пополнение кошелька выпоняется автоматически с любого дебетового банковского счета пользователя, привязанного к сервису Smart Pay. Пользователь может привязать один или несколько счетов 
